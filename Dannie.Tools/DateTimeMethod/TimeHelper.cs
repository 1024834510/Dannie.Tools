...
namespace System
{
    ...
    /// <para>文件名：TimeHelper</para>
    /// <para>
    ///     文件功能描述：
    ///         <para>扩展工具类：时间相关操作帮助</para>
    /// </para>
    /// <para>创建者：付冰玉昊 (Administrator)</para>
    /// <para>创建时间：2020-09-02 13:20:31</para>
    /// <para>修改人：付冰玉昊 (Administrator)</para>
    /// <para>修改时间：2020-09-02 13:20:31</para>
    /// <para>修改说明：</para>
    /// <para>测试人：</para>
    /// <para>测试时间：</para>
    /// <para>测试描述：</para>
    ...
    /// <para>编号：830ad0d9-a3f7-4cb5-a9c8-cf853d87411e</para>
    ...
    public static class TimeHelper
    {
        ...
        /// <returns>分钟数</returns>
        public static int SecondToMinute(this DateTime _, int second) => Convert.ToInt32(Math.Ceiling(second / (decimal)60));
        #endregion
        ...
        /// <param name="month">月份</param>
        /// <returns>日</returns>
        public static int GetMonthLastDate(this DateTime _, int year, int month) => new DateTime(year, month, new GregorianCalendar().GetDaysInMonth(year, month)).Day;
        #endregion
        ...
        public static string GetDateString(this DateTime dt) => dt.Year + dt.Month.ToString().PadLeft(2, '0') + dt.Day.ToString().PadLeft(2, '0');
        #endregion
