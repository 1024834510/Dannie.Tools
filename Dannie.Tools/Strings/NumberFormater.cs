...
namespace System
{
    ...
    /// <para>文件名：NumberFormater</para>
    /// <para>
    ///     文件功能描述：
    ///         <para></para>
    /// </para>
    /// <para>创建者：付冰玉昊 (Administrator)</para>
    /// <para>创建时间：2020-09-02 13:35:18</para>
    /// <para>修改人：付冰玉昊 (Administrator)</para>
    /// <para>修改时间：2020-09-02 13:35:18</para>
    /// <para>修改说明：</para>
    /// <para>测试人：</para>
    /// <para>测试时间：</para>
    /// <para>测试描述：</para>
    ...
    /// <para>编号：335afc39-1439-428b-ab1e-1131b68d433c</para>
    ...
    public class NumberFormater
    {
        ...
        public override string ToString() => Length + "进制模式，进制符：" + Characters;
        #endregion
